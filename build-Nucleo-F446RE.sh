...
O7ARMv7MP.Compile SynthCommon/s SynthBoardSynthNucleo64F4/s SynthTables/s SynthSynth/s SynthSynthesizer

O7ARMv7MLinker.Link STM32F446RE SynthSynthesizer
DATA
